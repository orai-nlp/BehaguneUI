...
/*try{
 show_chart('timeChartSmall',400,150);
}
catch(ex){
 console.log(ex);
}*/
...
function main_page_graphs() {
  ...
  show_source_tag_cloud('#sourceTagCloud', $('#tagCloud').parent().parent().width(), $('#tagCloud').parent().parent().width() / 1.7);
  show_source_tag_cloud('#sourceTagCloudSmall', $('#tagCloud').parent().parent().width(), $('#tagCloud').parent().parent().width() / 3.8);
  ...
  show_chart('timeChartSmall', $('#timeChartSmall').width() * 1.1, $('#timeChartSmall').width() / 2.4);
  $('#tagCloud').toggle();
  $('#pieChart').toggle();
  $('#timeChart').toggle();
  $('#countChart').toggle();
  $('#timeChartSmall').toggle();
  $('#countChartSmall').toggle();
  $('#sourceTagCloud').toggle();
  $('#sourceTagCloudSmall').toggle();
}
...
/*$('a[name=\'graph_selector\']').click(function () {
  if ($(this).attr('id') == 'graph_polarity') {
    $('#graph_polarity').attr('class', 'active');
    $('#graph_data').attr('class', '')
    $("#pieChart").show();
    $("#timeChart").hide();
    } 
  
  else {
    $('#graph_polarity').attr('class', '');
    $('#graph_data').attr('class', 'active'); 
    $("#pieChart").hide();
    $("#timeChart").show();   
    }
});*/
...
function reload_with_filters() {
  ...
  $.ajax({
    ...
    if ($('#id_source').val() == '' && $('#id_tag').val() == '') {
      ...
      $('#sourceTagCloud svg').remove();
      $('#sourceTagCloudSmall svg').remove();
      show_tag_cloud('#tagCloud', $('#tagCloud').parent().parent().width(), $('#tagCloud').parent().parent().width() / 1.7);
      show_tag_cloud('#tagCloudSmall', $('#tagCloud').parent().parent().width(), $('#tagCloud').parent().parent().width() / 3.8);
      show_source_tag_cloud('#sourceTagCloud', $('#tagCloud').parent().parent().width(), $('#tagCloud').parent().parent().width() / 1.7);
      show_source_tag_cloud('#sourceTagCloudSmall', $('#tagCloud').parent().parent().width(), $('#tagCloud').parent().parent().width() / 3.8);
    ...
    $('#timeChartSmall svg').remove();
    $('#timeChart').html('<svg class="visualisation"></div>');
    $('#timeChartSmall').html('<svg class="visualisation"></div>');
    show_chart('timeChart', $('#timeChart').width() * 1.1, $('#timeChart').width() * 1.2);
    show_chart('timeChartSmall', $('#timeChartSmall').width() * 1.1, $('#timeChartSmall').width() / 2.4);
